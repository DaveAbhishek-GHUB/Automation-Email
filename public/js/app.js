...
const Icons = {
  ...
  settings: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93A10 10 0 0 1 21 12a10 10 0 0 1-2.07 6.14M4.93 4.93A10 10 0 0 0 3 12a10 10 0 0 0 2.07 6.14"/><path d="M14.83 9.17a4 4 0 1 0-5.66 5.66"/></svg>`,
  ...
  trash:    `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2"/></svg>`,
  ...
  mousePointer: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m4 4 7.07 17 2.51-7.39L21 11.07z"/></svg>`,
...
function statusBadge(status) {
  const map = {
    ...
    scheduled:       `<span class="badge badge-scheduled">${Icons.clock} Scheduled</span>`,
    running:         `<span class="badge badge-running">${Icons.activity} Sending</span>`,
    sequence_active: `<span class="badge badge-sequence_active">${Icons.refresh} Sequence</span>`,
    completed:       `<span class="badge badge-completed">${Icons.check} Done</span>`,
    failed:          `<span class="badge badge-failed">${Icons.x} Failed</span>`,
    active:          `<span class="badge badge-active">${Icons.check} Active</span>`,
    unsubscribed:    `<span class="badge badge-failed">Unsub</span>`,
    sent:            `<span class="badge badge-scheduled">Sent</span>`,
    opened:          `<span class="badge badge-completed">Opened</span>`,
    clicked:         `<span class="badge badge-active">Clicked</span>`,
  };
...
function setButtonLoading(btn, loading, text) {
  if (!btn) return;
  if (loading) { btn._orig = btn.innerHTML; btn.innerHTML = text || 'Loading…'; btn.classList.add('loading'); }
